...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94741259325")
...
global.github = 'https://github.com/Sandesh-Md'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/mrunknown' // add your username
global.sudo = process.env.SUDO || '94741259325,94741259325'
global.devs = '2347039570336';
global.website = 'https://wa.me/+940769863183?text=𝘏𝘦𝘺_bbh' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/49ceffdee14dac505f424.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'SANDESH-MD-BOT' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'SANDESH-Md' : process.env.PACK_INFO.split(";")[1],
